...
with today as (
    select
        ...
        date_trunc('YEAR', current_day) as current_year_start
),
...
select
    ...
    to_char(day_dt, 'YYYY-MM-DD') as day_text,
    ...
    month_end_dt - month_start_dt + 1 as days_in_month,
